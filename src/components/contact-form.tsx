...
export function ContactForm() {
  ...
  if (submitted) {
    return (
      <div style={{ textAlign: "center", padding: "30px 10px" }}>
        ...
        <h2 className="display" style={{ fontWeight: 700, fontSize: 26, margin: "0 0 12px" }}>
          {form.success.title}
        </h2>
        <p
          style={{
  ...
  return (
    ...
    >
      <h2 className="display" style={{ fontWeight: 700, fontSize: 26, margin: "0 0 26px" }}>
        {form.title}
      </h2>
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <label className="field">
          ...
          <select className="field__input" name="interest" defaultValue={form.interest.options[0]}>

...
export const site = {
  ...
  home: {
    ...
    howPreview: {
      ...
      image: { src: '/nathan-with-client.webp', alt: '' },
    },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          {
            label: 'Instagram',
            href: 'https://www.instagram.com/shearsperformance/',
          },
          { label: 'TikTok', href: 'https://www.tiktok.com/@nathan_shears2' },
          {
            label: 'LinkedIn',
            href: 'https://www.linkedin.com/in/nathanshears/',
          },
